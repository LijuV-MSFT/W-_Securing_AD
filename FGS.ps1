...
param(
    [bool]   $VerboseOutput = $true,  # Determine if the Write-Verbose will be displayed on the screen
    [bool]   $DebugOutput   = $true,  # Determine if the Write-Debug will be displayed on the screen
    ...
    [bool]   $SkipExport    = $false, # If $True, we skip the generation of the XML files
